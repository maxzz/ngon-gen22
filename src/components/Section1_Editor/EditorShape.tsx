...
export function EditorShape(props: HTMLAttributes<SVGSVGElement>) {
    ...
    return (
        ...
        >
            ...
            {/* <path className="stroke-transparent fill-primary-300/30" style={{ strokeWidth: shapeParams.stroke }} d={createShading(shapeParams, shape).join('')} /> */}
